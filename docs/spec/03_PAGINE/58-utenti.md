...
- Contratto logico macchina: [`LOGICA_JSON/58-utenti.json`](LOGICA_JSON/58-utenti.json)
...
- profilo, ruolo, attivazione/disattivazione
- invito/reset tramite provider
...
1. Elencare utenti con ruolo, stato, ultimo accesso e MFA senza esporre credenziali.
2. Creazione invia un invito sicuro; modifica ruolo mostra differenze permessi e richiede step-up per privilegi elevati.
3. Disattivazione revoca sessioni; eliminazione logica conserva audit e riferimenti storici.
