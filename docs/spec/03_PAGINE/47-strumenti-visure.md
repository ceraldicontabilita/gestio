...
- `GET /api/openapi-imprese/cerca?query={param}&limit=10` — `verificare contratto dinamico` — sorgente: frontend/src/pages/Visure.jsx
- `GET /api/openapi-imprese/info/{param}?tipo=advanced` — `verificare contratto dinamico` — sorgente: frontend/src/pages/Visure.jsx
- `POST /api/openapi-imprese/aggiorna-fornitore` — `tenere` — sorgente: frontend/src/pages/Visure.jsx
...
- `GET /api/openapi-imprese/cerca` — `tenere` — in uso: FE
...
- `frontend/src/pages/Visure.jsx — SHA-256 `69753ee6fbefaa68d3a39a8e8c13da3a5aa0b126d2deb8fe9a3f50e278dc3780` — 454 righe`
