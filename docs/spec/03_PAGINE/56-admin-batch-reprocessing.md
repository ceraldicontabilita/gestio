...
- `GET /api/batch-reprocess/preview` — `tenere` — sorgente: frontend/src/pages/BatchReprocessing.jsx
- `GET /api/batch-reprocess/status` — `tenere` — sorgente: frontend/src/pages/BatchReprocessing.jsx
- `POST /api/batch-reprocess/start?{param}` — `verificare contratto dinamico` — sorgente: frontend/src/pages/BatchReprocessing.jsx
...
- `POST /api/batch-reprocess/start` — `tenere` — in uso: FE, scheduler
...
- `frontend/src/pages/BatchReprocessing.jsx — SHA-256 `a6c9f0af4e91b02616063ded07b3aff4f7b55f0851257d96cd7c49a7be567f88` — 211 righe`
