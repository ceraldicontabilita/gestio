...
- `GET /api/openapi/xbrl/bilancio/{param}` — `verificare contratto dinamico` — sorgente: frontend/src/pages/IntegrazioniOpenAPI.jsx
- `GET /api/openapi/xbrl/status` — `tenere` — sorgente: frontend/src/pages/IntegrazioniOpenAPI.jsx
- `GET /api/openapi/xbrl/storico-richieste?limit=20` — `verificare contratto dinamico` — sorgente: frontend/src/pages/IntegrazioniOpenAPI.jsx
- `POST /api/openapi/xbrl/richiedi-bilancio` — `tenere` — sorgente: frontend/src/pages/IntegrazioniOpenAPI.jsx
...
- `/api/openapi/xbrl/bilancio/{param}` — endpoint rilevato nella mappa; metodo/contratto da verificare
- `GET /api/openapi/xbrl/bilancio/{request_id}` — `tenere` — in uso: FE
- `GET /api/openapi/xbrl/download/{request_id}` — `tenere` — in uso: FE
- `/api/openapi/xbrl/download/{request_id}/pdf` — endpoint rilevato nella mappa; metodo/contratto da verificare
- `/api/openapi/xbrl/download/{request_id}/verbale` — endpoint rilevato nella mappa; metodo/contratto da verificare
- `/api/openapi/xbrl/download/{request_id}/xbrl` — endpoint rilevato nella mappa; metodo/contratto da verificare
- `GET /api/openapi/xbrl/storico-richieste` — `tenere` — in uso: FE
...
- `frontend/src/pages/IntegrazioniOpenAPI.jsx — SHA-256 `94c57dbba7959ef794218a7b44feb0da8a7a9a539d6d0d67f5bf420fde671346` — 405 righe`
