...
- Contratto logico macchina: [`LOGICA_JSON/37-archivio-bonifici.json`](LOGICA_JSON/37-archivio-bonifici.json)
...
- descrizione e periodo persistenti
- relazioni salario/fattura/banca
...
1. Indicizzare data, importo, ordinante, beneficiario, IBAN, CRO/TRN e causale senza perdere il testo originale.
2. Mostrare da associare e associati, con campo descrizione/nota modificabile e persistente.
3. Associa salario applica la regola del giorno 25; associa fattura usa identità/provenienza e candidati motivati.
